...
export const PUBLIC_ROUTES: RouteMeta[] = [
  ...
  { path: "/verify/:verificationId", title: "Verification Record — LAGDA",                  description: "Verify the authenticity of a LAGDA-signed document using a Verification ID or QR code.", breadcrumb: "Verify Document",   section: "verification", product: "verification", layout: "public", requiresAuth: false, isPublic: true, isIndexable: false, status: "implemented", analyticsName: "public_verify_record" },
...
export const AUTH_ROUTES: RouteMeta[] = [
  ...
  { path: "/invitations/accept", title: "Accept Invitation — LAGDA",          breadcrumb: "Accept Invitation", section: "auth", product: "shared", layout: "auth", requiresAuth: false, isPublic: false, isIndexable: false, status: "implemented", analyticsName: "accept_invitation_link", description: "The workspace invitation email's link. Accepting sends a request an owner or administrator approves." },
  { path: "/join/:token",       title: "Join a Workspace — LAGDA",            breadcrumb: "Join Workspace",    section: "auth", product: "shared", layout: "auth", requiresAuth: false, isPublic: false, isIndexable: false, status: "implemented", analyticsName: "join_workspace_link", description: "Ask to join a workspace with a single-use join link. An owner or administrator approves the request." },
  ...
  { path: "/onboarding/use-case",      title: "Your Profile — LAGDA",         breadcrumb: "Profile",       section: "auth", product: "shared", layout: "auth", requiresAuth: true,  isPublic: false, isIndexable: false, status: "implemented", analyticsName: "onboarding_use_case_redirect", canonicalPath: "/onboarding/profile", description: "Retired onboarding step — redirects to /onboarding/profile." },
  ...
  { path: "/onboarding/security",      title: "Protect Your Account — LAGDA",  breadcrumb: "Security",      section: "auth", product: "shared", layout: "auth", requiresAuth: true,  isPublic: false, isIndexable: false, status: "implemented", analyticsName: "onboarding_security" },
  { path: "/onboarding/notifications", title: "Review Your Setup — LAGDA",    breadcrumb: "Review",        section: "auth", product: "shared", layout: "auth", requiresAuth: true,  isPublic: false, isIndexable: false, status: "implemented", analyticsName: "onboarding_notifications_redirect", canonicalPath: "/onboarding/review", description: "Retired onboarding step — redirects to /onboarding/review." },
...
export const PLATFORM_ROUTES: RouteMeta[] = [
  ...
  // Nothing links here; the signing tab opens it. Not indexable and not in
  // the sitemap: it is only ever reached with a one-time code in the URL.
  { path: "/app/link-signing", title: "Confirm your account | LAGDA", description: "Confirm that a signing request was addressed to your account.", breadcrumb: "Confirm account", section: "platform", product: "esignature", layout: "platform", requiresAuth: true, isPublic: false, isIndexable: false, status: "implemented", analyticsName: "platform_link_signing" },
  ...
  { path: "/app/prepare/authorization",                 title: "Authorization — LAGDA",                          breadcrumb: "Authorization",         section: "platform", product: "esignature", layout: "platform", requiresAuth: true, isPublic: false, isIndexable: false, status: "implemented", analyticsName: "platform_prepare_authorization", description: "Final confirmation before a document is sent for signing." },
  ...
  { path: "/app/templates/gallery",                     title: "Ready-made Templates — LAGDA",                 breadcrumb: "Ready-made",            section: "platform", product: "esignature", layout: "platform",  requiresAuth: true, isPublic: false, isIndexable: false, status: "implemented", analyticsName: "platform_templates_gallery",   description: "Browse ready-made templates with roles already set up, grouped by purpose." },
  { path: "/app/templates/gallery/:readyId",            title: "Ready-made Template Preview — LAGDA",          breadcrumb: "Preview",               section: "platform", product: "esignature", layout: "platform",  requiresAuth: true, isPublic: false, isIndexable: false, status: "implemented", analyticsName: "platform_templates_gallery_preview", description: "Preview a ready-made template's document and roles before using it." },
  ...
  // layout: "platform" is a LayoutType approximation; the author editor renders its own full-screen shell in the router.
  { path: "/app/templates/:templateId/author",          title: "Author Document — LAGDA",                      breadcrumb: "Author",                section: "platform", product: "esignature", layout: "platform",  requiresAuth: true, isPublic: false, isIndexable: false, status: "implemented", analyticsName: "platform_template_author",     description: "Author this template's document from scratch instead of uploading one." },
  ...
  { path: "/app/upload-requests",                        title: "Document Requests — LAGDA",                    breadcrumb: "Document Requests",     section: "platform", product: "esignature", layout: "platform",  requiresAuth: true, isPublic: false, isIndexable: false, status: "implemented", analyticsName: "platform_upload_requests",     description: "Documents your workspace has asked people to supply, and the ones asked of you." },
  ...
  { path: "/app/workspace/join-requests",               title: "Join Requests — LAGDA",                          breadcrumb: "Join requests",         section: "platform", product: "esignature", layout: "platform", requiresAuth: true, isPublic: false, isIndexable: false, status: "implemented", analyticsName: "platform_workspace_join_requests", description: "People waiting for an owner or administrator to approve their request to join." },
  { path: "/app/workspace/join-links",                  title: "Join Links — LAGDA",                             breadcrumb: "Join links",            section: "platform", product: "esignature", layout: "platform", requiresAuth: true, isPublic: false, isIndexable: false, status: "implemented", analyticsName: "platform_workspace_join_links",    description: "Single-use links that let someone ask to join this workspace." },
  ...
  { path: "/app/workspace/documents",                   title: "Signed Documents — LAGDA",                       breadcrumb: "Signed Documents",      section: "platform", product: "esignature", layout: "platform", requiresAuth: true, isPublic: false, isIndexable: false, status: "implemented", analyticsName: "platform_workspace_documents",     description: "Every document sent for signing, its initiator, and its signing progress." },
  ...
  { path: "/app/verify/:verificationId",               title: "Verify a Document — LAGDA",                  breadcrumb: "Verification Record",             section: "platform", product: "verification",layout: "platform", requiresAuth: true, isPublic: false, isIndexable: false, status: "implemented", analyticsName: "platform_verify_record" },
  ...
  { path: "/app/settings/organization",                 title: "Organization Units — LAGDA",                   breadcrumb: "Organization Units",      section: "platform", product: "shared",     layout: "platform", requiresAuth: true, isPublic: false, isIndexable: false, status: "implemented", analyticsName: "settings_organization" },
