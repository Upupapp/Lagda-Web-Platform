...
export const TOP_NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Business Teams",   path: "/solutions/business",   description: "Internal approvals, contracts, and HR documents." },
      { label: "Government / LGU", path: "/solutions/government", description: "Official documents and public sector workflows." },
      { label: "Real Estate",      path: "/solutions/real-estate",description: "Property contracts, deeds, and broker agreements." },
      { label: "HR & Recruitment", path: "/solutions/hr",         description: "Employment contracts, NDAs, and onboarding." },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Signing Requests",  path: "/pricing/signing",      description: "How sending limits work across plans." },
      { label: "Storage Limits",    path: "/pricing/storage",      description: "Document storage per plan tier." },
      { label: "Templates by Plan", path: "/pricing/templates",    description: "Which templates are available on each plan." },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "IP / Device / Location Evidence", path: "/security/evidence",              description: "Signing evidence captured at each event." },
      { label: "Secure Storage",                  path: "/security/storage",               description: "Encrypted document storage and retention." },
    ],
  },
  {
    id: "resources",
    ...
    items: [
      { label: "Guides",                path: "/resources",         description: "Step-by-step guides for every LAGDA workflow." },
      { label: "FAQ",                   path: "/resources/faq",     description: "Answers to the most common LAGDA questions." },
      { label: "Legal Framework",       path: "/resources/legal",   description: "Philippine legal context for electronic signatures." },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Future Features",       path: "/enotary/features", description: "Secure video, electronic notarial book, digital seals.",    isComingSoon: true },
      { label: "Accreditation Roadmap", path: "/enotary/roadmap",  description: "Milestones toward Supreme Court accreditation.",            isComingSoon: true },
...
export const FOOTER_COLUMNS: FooterColumn[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Business Teams",   path: "/solutions/business" },
      { label: "Government / LGU", path: "/solutions/government" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Legal Framework", path: "/resources/legal" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Roadmap",        path: "/enotary/roadmap",  isComingSoon: true },
