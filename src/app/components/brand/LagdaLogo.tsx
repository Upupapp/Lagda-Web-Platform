...
// Renders the icon mark as inline SVG + wordmark text.
// Never use raw SVG in page components — always use this component.
//
// Variants:
//   colored-horizontal  — Azure icon + Deep Navy wordmark  (light backgrounds)
//   white-horizontal    — Azure icon + White wordmark       (dark/navy backgrounds)
//   black-horizontal    — Mono icon + Black wordmark        (monochrome/print)
//   colored-icon        — Azure icon, no wordmark           (compact contexts)
//   white-icon          — White-frosted icon, no wordmark   (dark compact contexts)
//   mono-icon           — Navy icon, no wordmark            (monochrome compact)
...
const ICON_CONFIGS: Record<LogoVariant, IconConfig> = {
  "colored-horizontal": { rectFill: "#0078D4", shieldStroke: "#ffffff" },
  "white-horizontal":   { rectFill: "#0078D4", shieldStroke: "#ffffff" },
  "black-horizontal":   { rectFill: "#07111F", shieldStroke: "#ffffff" },
  "colored-icon":       { rectFill: "#0078D4", shieldStroke: "#ffffff" },
  "white-icon":         { rectFill: "rgba(255,255,255,0.12)", shieldStroke: "#ffffff" },
  "mono-icon":          { rectFill: "#07111F", shieldStroke: "#ffffff" },
};
...
const WORDMARK_CONFIGS: Record<LogoVariant, WordmarkConfig | null> = {
  "colored-horizontal": { nameColor: "#07111F", taglineColor: "#0078D4" },
  "white-horizontal":   { nameColor: "#ffffff", taglineColor: "#60A5FA" },
  "black-horizontal":   { nameColor: "#07111F", taglineColor: "#334155" },
  "colored-icon": null,
  "white-icon":   null,
  "mono-icon":    null,
};
...
export function LagdaLogo({
  ...
  const rx        = Math.round(iconSize * 0.2); // ~8px at md, scales proportionally
  ...
  const icon = (
    ...
    >
      ...
      <path d={SHIELD_PATH} stroke={iconCfg.shieldStroke} strokeWidth="2" />
    </svg>
  );
