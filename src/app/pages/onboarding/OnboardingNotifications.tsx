...
type BoolKey = {
  [K in keyof NotificationsDraft]: NotificationsDraft[K] extends boolean
    ? K
    : never;
}[keyof NotificationsDraft];
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          <div>
            ...
            >
              <NotifRow
                ...
                checked={n.docViewed}
                onChange={set("docViewed")}
              />
              <NotifRow
                label="Signature completed"
                checked={n.signatureCompleted}
                onChange={set("signatureCompleted")}
              />
              <NotifRow
                label="Approval completed"
                checked={n.approvalCompleted}
                onChange={set("approvalCompleted")}
              />
              <NotifRow
                label="Participant declined"
                checked={n.participantDeclined}
                onChange={set("participantDeclined")}
              />
              <NotifRow
                label="Delivery failed"
                checked={n.deliveryFailed}
                onChange={set("deliveryFailed")}
              />
              <NotifRow
                label="Request expiring soon"
                checked={n.requestExpiring}
                onChange={set("requestExpiring")}
              />
              <NotifRow
                label="All participants completed"
                checked={n.requestCompleted}
                onChange={set("requestCompleted")}
              />
            </div>
          </div>
          ...
          <div>
            ...
            >
              <NotifRow
                label="New sign-in from a different device"
                checked={n.newSignIn}
                onChange={set("newSignIn")}
              />
              <NotifRow
                label="Security alerts"
                checked={n.securityAlert}
                onChange={set("securityAlert")}
              />
              <NotifRow
                label="Workspace invitation received"
                checked={n.workspaceInvitation}
                onChange={set("workspaceInvitation")}
              />
              <NotifRow
                label="Role or permission changed"
                checked={n.roleChanged}
                onChange={set("roleChanged")}
              />
            </div>
          </div>
          ...
          <div>
            ...
            >
              ...
              />
              <NotifRow
                label="Guides and educational resources"
                checked={n.guidesEducation}
                onChange={set("guidesEducation")}
              />
            </div>
          </div>
