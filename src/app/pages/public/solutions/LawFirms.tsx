  ...
  return (
    <div aria-hidden style={{
      ...
      <div style={{ padding: "12px 16px", borderBottom: "1px solid rgba(0,0,0,0.08)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div>
          <p style={{ color: "#07111F", ...GF, fontSize: 12, fontWeight: 700, margin: 0 }}>Northbridge Legal Group</p>
          <p style={{ color: "#64748B", ...GM, fontSize: 10, margin: "1px 0 0" }}>Firm Workspace · 4 members</p>
        </div>
        <span style={{ background: "rgba(0,120,212,0.1)", color: "#0078D4", ...GM, fontSize: 9, fontWeight: 700, padding: "2px 8px", borderRadius: 999, border: "1px solid rgba(0,120,212,0.25)" }}>WORKSPACE</span>
      </div>
      {members.map((m) => (
        <div key={m.name} style={{ padding: "9px 16px", borderBottom: "1px solid rgba(0,0,0,0.06)", display: "flex", gap: 10, alignItems: "center" }}>
          <div style={{ width: 28, height: 28, borderRadius: "50%", background: "rgba(0,120,212,0.12)", display: "flex", alignItems: "center", justifyContent: "center", ...GM, fontSize: 9, fontWeight: 700, color: "#0078D4", flexShrink: 0 }}>{m.avatar}</div>
          <div style={{ flex: 1 }}>
      ...
      <div style={{ padding: "10px 16px", background: "#f8fafb", display: "flex", gap: 14 }}>
        <span style={{ color: "#0078D4", ...GF, fontSize: 11, fontWeight: 700 }}>+ Invite member</span>
        <span style={{ color: "#64748B", ...GF, fontSize: 11 }}>7 templates · 26 active</span>
      </div>
    </div>
  );
}
    ...
    <SolPageShell>
      ...
      <PageSection id="challenges" light bordered>
        <div style={{ display: "grid", gap: "32px 48px", alignItems: "start" }} className="lf-two-col">
          ...
          <div>
            <p style={{ color: "#64748B", ...GM, fontSize: 10, fontWeight: 700, letterSpacing: "0.08em", marginBottom: 12 }}>FIRM WORKSPACE</p>
            <FirmWorkspaceMockup />
          </div>
        </div>
