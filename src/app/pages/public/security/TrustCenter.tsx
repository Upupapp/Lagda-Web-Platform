    ...
    <SecurityPageShell>
        ...
        <div style={{ display: "grid", gap: 12 }} className="tr-grid">
          {TRUST_RESOURCES.map((r) => (
            <a key={r.path} href={r.path} style={{ textDecoration: "none" }}>
              <div style={{ background: "#ffffff", border: "1px solid rgba(0,0,0,0.08)", borderRadius: 12, padding: "16px 16px", height: "100%", boxShadow: "0 1px 4px rgba(7,17,31,0.07)" }}>
      ...
      <PageSection id="disclosure">
        ...
        <div style={{ maxWidth: 600, margin: "0 auto" }}>
          <div style={{ background: "#ffffff", border: "1px solid rgba(0,0,0,0.08)", borderRadius: 14, padding: "24px 24px", boxShadow: "0 1px 4px rgba(7,17,31,0.07)" }}>
            <p style={{ color: "#64748B", ...GM, fontSize: 10, fontWeight: 700, letterSpacing: "0.08em", marginBottom: 12 }}>RESPONSIBLE DISCLOSURE</p>
            <p style={{ color: "#334155", ...GF, fontSize: 14, lineHeight: 1.7, marginBottom: 16 }}>
      ...
      <PageSection id="no-claims" light bordered>
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          <p style={{ color: "#B45309", ...GM, fontSize: 10, fontWeight: 700, letterSpacing: "0.08em", marginBottom: 10 }}>WHAT THIS PAGE DOES NOT DO</p>
