  ...
  return (
    <SecurityPageShell>
              ...
              {AUTH_COMPARISON.map((row) => (
                <tr key={row.method} style={{ borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
                  ...
                  <td style={{ padding: "10px 12px", textAlign: "center" }}>
                    <span style={{ color: row.independentChannel ? "#22C55E" : "#475569", fontSize: 14 }}>{row.independentChannel ? "✓" : "—"}</span>
                  </td>
                  <td style={{ padding: "10px 12px" }}>
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 4 }}>
                      {row.evidenceRecorded.map((e) => (
                        <span key={e} style={{ background: "rgba(255,255,255,0.05)", color: "#64748b", ...GM, fontSize: 9, padding: "2px 6px", borderRadius: 4 }}>{e}</span>
                      ))}
                    </div>
                  </td>
                  <td style={{ padding: "10px 12px" }}>
      ...
      <PageSection id="risk-model" light bordered>
        ...
        <p style={{ color: "#475569", ...GF, fontSize: 13, marginTop: 14, lineHeight: 1.6, textAlign: "center" }}>
