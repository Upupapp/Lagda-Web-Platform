...
// â”€â”€ Parallel vs sequential visual â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      <div style={{ background: "rgba(0,120,212,0.06)", border: "1px solid rgba(0,120,212,0.2)", borderRadius: 14, padding: "20px 18px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 6, marginBottom: 12 }}>
          {["Ana Reyes · Signer", "Marco Santos · Signer"].map((p) => (
            <div key={p} style={{ background: "rgba(0,120,212,0.12)", border: "1px solid rgba(0,120,212,0.2)", borderRadius: 8, padding: "7px 12px", ...GF, fontSize: 12, fontWeight: 600, color: "#07111F" }}>
              {p}
            </div>
          ))}
        </div>
        <div style={{ height: 1, background: "rgba(0,120,212,0.25)", marginBottom: 12 }} />
        <div style={{ background: "rgba(34,197,94,0.1)", border: "1px solid rgba(34,197,94,0.25)", borderRadius: 8, padding: "7px 12px", ...GF, fontSize: 12, fontWeight: 600, color: "#178A4C", display: "inline-flex" }}>
...
// â”€â”€ Reminders mockup â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <div aria-hidden style={{
      ...
      <div style={{ padding: "12px 16px", borderBottom: "1px solid rgba(0,0,0,0.07)" }}>
        <span style={{ color: "#07111F", ...GF, fontSize: 12, fontWeight: 700 }}>Reminder Settings</span>
      </div>
      {[
        ...
        <div key={row.label} style={{ padding: "9px 16px", borderBottom: "1px solid rgba(0,0,0,0.05)", display: "flex", gap: 12 }}>
          <span style={{ color: "#64748B", ...GM, fontSize: 10, flexShrink: 0, minWidth: 120 }}>{row.label}</span>
          <span style={{ color: "#64748B", ...GF, fontSize: 12 }}>{row.value}</span>
        </div>
      ))}
...
// â”€â”€ Capabilities table â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function CapabilitiesTable() {
  const tiers = ["Core", "Advanced", "Enterprise"] as const;
  const tierColors = { Core: "#178A4C", Advanced: "#0078D4", Enterprise: "#C9960C" };
          ...
          <div key={cap.title} style={{
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", marginBottom: 3 }}>
                <span style={{ color: "#07111F", ...GF, fontSize: 13, fontWeight: 700 }}>{cap.title}</span>
  ...
  return (
    <EsigPageShell>
      ...
      <PageSection id="routing" light bordered>
        ...
        <div style={{ marginTop: 20, background: "#ffffff", border: "1px solid rgba(0,0,0,0.08)", borderRadius: 12, padding: "16px 18px" }}>
          <p style={{ color: "#0078D4", ...GM, fontSize: 10, fontWeight: 700, letterSpacing: "0.06em", marginBottom: 8 }}>MIXED ROUTING EXAMPLE</p>
      ...
      <PageSection id="organization" light bordered>
        ...
        <div style={{ display: "grid", gap: 12 }} className="org-grid">
          {[
            ...
            <div key={f.title} style={{ background: "#ffffff", border: "1px solid rgba(0,0,0,0.08)", borderRadius: 12, padding: "14px 14px" }}>
