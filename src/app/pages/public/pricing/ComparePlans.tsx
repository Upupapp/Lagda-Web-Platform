    ...
    <PricingPageShell>
      <section style={{ padding: "64px 24px 48px", background: "radial-gradient(ellipse 70% 40% at 50% 0%, rgba(0,120,212,0.1) 0%, transparent 70%)" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
          <p style={{ color: "#0078D4", ...GM, fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 12 }}>PLAN COMPARISON</p>
          <h1 style={{ color: "#07111F", ...GF, fontSize: "clamp(26px, 4.5vw, 46px)", fontWeight: 900, lineHeight: 1.1, letterSpacing: "-0.03em", margin: "0 0 16px" }}>
      ...
      <PricingSection id="auth-detail">
        ...
        <div style={{ marginTop: 16 }}>
          <Link to="/pricing/authentication-by-plan" style={{ color: "#0078D4", ...GF, fontSize: 14, textDecoration: "none", fontWeight: 600 }}>
