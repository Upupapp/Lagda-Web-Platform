          ...
          <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 520 }} aria-label="Template availability by plan">
            <thead>
              <tr style={{ borderBottom: "1px solid rgba(255,255,255,0.1)" }}>
                <th style={{ textAlign: "left", padding: "10px 16px 10px 0", color: "#475569", ...GF, fontSize: 13, fontWeight: 600, width: "50%" }}>Template feature</th>
              ...
              {TEMPLATE_DIMENSIONS.map(({ icon, title, personal, business, enterprise }) => (
                <tr key={title} style={{ borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
                  ...
                  <td style={{ textAlign: "center", padding: "10px 12px" }}>
                    {personal ? <span style={{ color: "#22C55E" }}>✓</span> : <span style={{ color: "#334155" }}>—</span>}
                  </td>
                  <td style={{ textAlign: "center", padding: "10px 12px", background: "rgba(0,120,212,0.04)" }}>
                    {business ? <span style={{ color: "#22C55E" }}>✓</span> : <span style={{ color: "#334155" }}>—</span>}
                  </td>
                  <td style={{ textAlign: "center", padding: "10px 12px" }}>
                    {enterprise ? <span style={{ color: "#22C55E" }}>✓</span> : <span style={{ color: "#334155" }}>—</span>}
                  </td>
                </tr>
              ))}
            </tbody>
