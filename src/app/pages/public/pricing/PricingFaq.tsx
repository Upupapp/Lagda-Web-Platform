    ...
    <PricingPageShell>
      <section style={{ padding: "64px 24px 48px" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          <p style={{ color: "#0078D4", ...GM, fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 12 }}>FAQ</p>
      ...
      <PricingSection id="more-questions">
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          <div style={{ background: "#ffffff", border: "1px solid rgba(0,0,0,0.08)", borderRadius: 14, padding: "24px 28px", display: "flex", gap: 20, alignItems: "flex-start", flexWrap: "wrap", boxShadow: "0 1px 4px rgba(7,17,31,0.07)" }}>
            <div style={{ flex: 1, minWidth: 200 }}>
              <p style={{ color: "#07111F", ...GF, fontSize: 16, fontWeight: 700, margin: "0 0 6px" }}>Have another question?</p>
